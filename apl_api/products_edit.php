...
if (!filter_var($product_id, FILTER_VALIDATE_INT)) //THIS CODE SNIPPET IS CUSTOM IN API. ORIGINAL CODE HASN'T THIS SNIPPET (ID IS VALIDATED EARLIER IN ORIGINAL CODE)
    {
